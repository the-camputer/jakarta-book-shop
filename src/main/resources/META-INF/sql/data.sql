...
insert into BOOK(book_id, title, isbn13, num_pages, publication_date, publisher_id)
VALUES (next value for seq_book_id, 'The Obelisk Gate', '9780316229289', 448, '2016-09-16', 100);
insert into BOOK(book_id, title, isbn13, num_pages, publication_date, publisher_id)
VALUES (next value for seq_book_id, 'The Stone Sky', '9780316229258', 464, '2017-09-15', 100);
